...
def traffic_monitor_callback(pkt):
    if IP in pkt:
        ...
        #if ("192.168.0." not in str(src_ip)) or ("8.8.8.8" not in str(src_ip)) or ("8.8.4.4" not in str(src_ip)):
            #return 
        
        #if ("192.168.0." not in str(dst_ip)) or ("8.8.8.8" not in str(dst_ip)) or ("8.8.4.4" not in str(dst_ip)):
            #return;
